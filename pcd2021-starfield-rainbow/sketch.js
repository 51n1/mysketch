...
function setup() {
  ...
  drawingContext.shadowColor = "rgba(255, 0, 255, .5)";
  ...
  gradient.addColorStop(0, "rgba(200, 250, 250, .5)");
  gradient.addColorStop(.99, "rgba(0, 30, 30, .3)");
